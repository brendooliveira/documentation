...
<Warning>
  Nunca gere uma chave nova ao repetir. É o erro que transforma uma indisponibilidade momentânea do
  provedor em uma cobrança duplicada no cartão do comprador.
</Warning>
