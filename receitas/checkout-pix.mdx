...
$resposta = Http::withToken(config('services.vext.key'))
    ...
    ->post('https://api.vext.com.br/v1/charges', [
...
<Warning>
  Não libere o produto na resposta de `POST /v1/charges`. Ela devolve `pending`. Liberar aí é
  entregar para quem só gerou o QR e foi embora.
</Warning>
...
```bash
curl "https://api.vext.com.br/v1/charges?status=pending&created_to=2026-08-04T14:00:00-03:00" \
...
<CardGroup cols={2}>
  <Card title="Conciliação" icon="list-checks" href="/receitas/conciliacao">
    Fechar o dia e casar tudo com os seus pedidos.
  </Card>
  <Card title="Ciclo de vida" icon="git-branch" href="/essenciais/ciclo-de-vida-da-cobranca">
