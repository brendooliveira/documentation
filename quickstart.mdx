...
<Warning>
  **Confira a assinatura antes de agir.** Quem tem o segredo consegue forjar este evento, e um
  sistema que libera produto ao recebê-lo entregaria de graça. O código pronto, nas quatro
  linguagens, está em [Verificar a assinatura](/webhooks/assinatura).
</Warning>
...
```bash
curl https://api.vext.com.br/v1/charges/ch_01k1y6r6m6q2x0p3d9v4t7c8n2 \
  -H "Authorization: Bearer sk_test_..."
```
