...
<Warning>
  Nunca repita em laço apertado depois de uma `429`. Repetição cega é o que transforma um pico de
  segundos em um bloqueio de minutos, porque cada tentativa recusada também conta.
</Warning>
