...
navegador pelo [embed](/embed/visao-geral), ou o `id` de um
...
<Frame caption="A grade como o embed a apresenta, com o total e os juros escritos por extenso.">
  <img src="/images/embed/parcelas.png" alt="Lista de parcelamento de 1x a 12x, com o valor de cada parcela e a indicação de juros" />
</Frame>
...
| `card_not_found` | `404` | O `pm_` não é do comprador daquela sessão |
...
<CardGroup cols={2}>
  <Card title="Embed no navegador" icon="credit-card" href="/embed/visao-geral">
    Cobrar sem que o número do cartão passe pelo seu servidor.
  </Card>
