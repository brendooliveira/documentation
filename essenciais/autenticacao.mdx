...
```bash
curl https://api.vext.com.br/v1/balance \
...
<Warning>
  A chave vai no **servidor**. Colocá-la no JavaScript do navegador a entrega a qualquer pessoa que
  abra as ferramentas de desenvolvedor da página — e com ela vêm as suas cobranças, os seus estornos
  e o seu saldo.
</Warning>
