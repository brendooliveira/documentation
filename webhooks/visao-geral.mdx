...
description: "Os seis eventos que enviamos, como cadastrar endpoints e o que responder."
icon: "webhook"
---
...
pedido. `charge.in_analysis` é o único que pede o contrário — esperar, porque a compra ainda pode
ser recusada.
