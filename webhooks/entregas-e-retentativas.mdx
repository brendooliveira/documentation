...
Escreva o handler para tolerar um `charge` com menos campos do que o normal, e ele sobrevive ao dia
...
está em [`GET /v1/charges/{code}`](/api-reference/cobrancas/consultar), e é de lá que você completa.
